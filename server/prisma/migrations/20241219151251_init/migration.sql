/*
  ...
  - You are about to drop the column `purschaseSummaryId` on the `PurchaseSummary` table. All the data in the column will be lost.
...
DROP COLUMN "purschaseSummaryId",
